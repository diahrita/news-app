        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{route('article.update', $editData->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="name">Judul</label>
                    <input name="judul" type="name" class="form-control" id="name" value="{{$editData->judul}}">
                  </div>
                  <div class="form-group">
                    <label>Konten</label>
                    <textarea name="konten" class="form-control" rows="3">{{$editData->konten}}</textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input name="slug" type="name" class="form-control" id="name" value="{{$editData->slug}}" placeholder="Nama Lengkap">
                  </div>
                  <div class="form-group">
                    <label for="name">Kutipan</label>
                    <input name="kutipan" type="name" class="form-control" id="name" value="{{$editData->kutipan}}" placeholder="Nama Lengkap">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Waktu Publish</label>
                      <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                          <input name="published_at" type="text" value="{{$editData->published_at}}" class="form-control datetimepicker-input" data-target="#reservationdatetime"/>
